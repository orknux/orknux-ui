...
export function ActionForm({
  ...
  const touched = JSON.stringify(settingsNow()) !== opened.current || action !== null || madeId !== null;
    ...
    <>
      <form className={styles.body} onSubmit={handleSubmit}>
        <div className={styles.fields}>
          ...
          {/*
            The signature, on the page where an action is a thing of its own.
            
            It answers "what will a node have to give this, and what comes
            back" for somebody looking at an action in the workspace's list,
            where there is no node to read it off.
            
            Left out of a node's panel, where all three of those things are
